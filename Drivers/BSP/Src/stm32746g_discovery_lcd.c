...
/*void WDA_LCD_RotateBitmap(const void *pSrc, uint32_t xPos, uint32_t yPos, uint32_t xSize, uint32_t ySize, uint32_t ColorMode, double angle)
{
    ...
    *//* Rotation Configuration *//*
    hDma2dHandler.Init.Rotation = (uint32_t)(angle * 182.0416667); // Convert angle to fixed-point format
